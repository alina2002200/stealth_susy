...
R2GC_Sgg = Coupling(name = 'R2GC_Sgg',
                    value = 'complex(0,1)*(-0.5)*gY*gY/(16*9.86960440109)',
                    order = {'QCD': 2, 'QED': 0})

R2GC_SYY = Coupling(name = 'R2GC_SYY',
                    value = 'complex(0,1)*(-3)*gY/(16*9.86960440109)',
                    order = {'QCD': 1, 'QED': 1})

UVGC_Sgg = Coupling(name = 'UVGC_Sgg',
                    value = 'complex(0,1)*gY*gY/(16*9.86960440109)',
                    order = {'QCD': 2, 'QED': 0})

UVGC_SYY = Coupling(name = 'UVGC_SYY',
                    value = 'complex(0,1)*gY/(16*9.86960440109)',
                    order = {'QCD': 1, 'QED': 1})

UVGC_YYg = Coupling(name = 'UVGC_YYg',
                    value = 'complex(0,1)*gS/(16*9.86960440109)',
                    order = {'QCD': 2, 'QED': 0})
